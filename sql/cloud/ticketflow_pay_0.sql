...
CREATE TABLE `d_refund_bill_0` (
  ...
  `out_refund_no` varchar(64) DEFAULT NULL COMMENT '退款单号（渠道幂等键、退款查询依据）',
  `refund_amount` decimal(10,2) NOT NULL COMMENT '退款金额',
  `refund_status` int(11) NOT NULL DEFAULT '1' COMMENT '账单退款状态 1：退款处理中 2：已退款 3：退款失败',
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态 1：未删除 0：删除',
  PRIMARY KEY (`id`),
  UNIQUE KEY `d_refund_bill_out_refund_no_IDX` (`out_refund_no`) USING BTREE
