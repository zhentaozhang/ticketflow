--- apiLimit.lua — 滑动窗口式 API 限流
--- KEYS[1] : JSON, 含 ruleKey / ruleType / statTime / threshold / effectiveTime / ruleLimitKey / zSetRuleStatKey / currentTime
--- 返回：{ trigger_result, trigger_call_Stat, api_count, threshold }
---   trigger_result = 1 表示触发限流，0 表示正常
---   trigger_call_Stat = 1 表示首次触发限流（用于通知/日志）
