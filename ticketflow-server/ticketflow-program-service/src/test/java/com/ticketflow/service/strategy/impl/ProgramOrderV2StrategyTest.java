...
class ProgramOrderV2StrategyTest {
    ...
    @InjectMocks
    private ProgramOrderV2Strategy programOrderV2Strategy;
    ...
    void createOrderShouldAcquireDistributedLockWithPrefixedNamePerTicketCategory() throws Exception {
        ...
        when(programOrderService.create(dto, ProgramOrderVersion.V2_VERSION.getValue())).thenReturn("orderNumber");

        assertEquals("orderNumber", programOrderV2Strategy.createOrder(dto));
