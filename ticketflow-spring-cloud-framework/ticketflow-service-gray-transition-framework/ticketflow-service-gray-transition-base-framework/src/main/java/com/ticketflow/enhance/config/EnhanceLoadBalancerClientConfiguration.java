...
package com.ticketflow.enhance.config;

import com.ticketflow.balance.FilterLoadBalance;
import com.ticketflow.enhance.EnhanceServiceInstanceListSupplierBuilder;
...
/**
 * LoadBalancer 客户端配置增强。
 * 为每个服务创建定制化的 LoadBalancer，注入灰度实例选择逻辑，
 * 实现按版本标识路由的灰度发布能力
 */
