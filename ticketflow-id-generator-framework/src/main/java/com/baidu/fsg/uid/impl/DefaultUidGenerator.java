 ...
 * <p>
 * The {@link DefaultUidGenerator#parseUid(long)} is a ticketflow method to parse the bits
 *
 * <pre>{@code
 * +------+----------------------+----------------+-----------+
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    /**
     * Customer epoch, unit as second. For ticketflow 2024-05-20 (ms: 1716134400000)
     */
